...
function HowToApply() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      a: (
        <span>
          No, it has a fixed time period of 6 months but if you wish to get
          incubated with IIT Kanpur you can always apply for incubation at SIIC,
          IIT Kanpur. <br className="mb-2" />
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl p-6 sm:p-8 border border-blue-100">
          ...
          <ul className="space-y-4 text-slate-700 list-none leading-relaxed text-sm sm:text-base">
            <li className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-slate-900">Step 1:</strong> Click the
                "Apply For Enrollment" card link to access the registration
                form.
              </div>
            </li>
            <li className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
              <div>
                <strong className="text-slate-900">Step 2:</strong> Fill out
                your startup concept, team size, and tech stack details
                carefully.
              </div>
            </li>
            <li className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
              <div>
                <strong className="text-slate-900">Step 3:</strong> Upload the
                required pitching deck templates from our downloads tab.
              </div>
            </li>
            <li className="flex items-start gap-3">
              <ArrowRight className="w-5 h-5 text-blue-600 shrink-0 mt-0.5" />
              <div>
                <strong className="text-slate-900">Step 4:</strong> Submit
                before the cohort closing deadline listed on the timeline.
              </div>
            </li>
          </ul>
        </div>
