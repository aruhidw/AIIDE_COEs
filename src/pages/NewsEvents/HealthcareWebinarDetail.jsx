        ...
        <article className="bg-white border border-slate-200 shadow-sm rounded-3xl overflow-hidden p-6 sm:p-10 lg:p-12">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-slate-600 text-sm sm:text-base leading-relaxed text-justify">
            <p className="font-medium text-slate-900 text-center text-base sm:text-lg mb-8 leading-normal">
              To boost the innovation and entrepreneurship ecosystem by
              leveraging AI/ML, the Government of Uttar Pradesh has entrusted
              Indian Institute of Technology, Kanpur, and FICCI to establish a
              world-class Centre of Excellence in Noida. Startup Incubation and
              Innovation Centre, IIT Kanpur is glad to announce the launch of
              the AIIDE-CoE website -{" "}
              <a
            ...
            <p>
              AIIDE will support 250 startups from the AI/ML domain over a
              period of 5 years. The startups will have access to world-class
              infrastructure and lab facilities, mentors, and investors to help
              accelerate their product development.
            </p>

            <p>
              With the launch of the AIIDE website by Honorable Deputy Chief
              Minister of Uttar Pradesh Dr. Dinesh Sharma, we have opened the
              call for applications for startups in the field of AI/ML.
            </p>
          </div>
